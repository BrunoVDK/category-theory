...
\newcommand{\block}[1]{\vspace{0cm}\begin{changemargin}{2.5cm}{2.5cm}\large\textit{#1}\end{changemargin}\vspace{0.6cm}}
\ThisCenterWallPaper{1.0}{res/cover.png}
...
%%% Title page
\casename{Category Theory for Programmers}
